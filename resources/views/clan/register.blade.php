@extends('layout.main', ['title' => 'Register a Clan'])
...
<div class="row-fluid">
	...
	<div class="span8">
		...
		{!! Form::open(['url' => '/clan/register']) !!}
		{!! Form::label('name', 'Clan name:') !!}
		{!! Form::text('name', '') !!}
		{!! Form::label('tag', 'Clan tag (ex: [TAG], Tag., _Tag, .Tag):') !!}
		{!! Form::text('tag', '') !!}
		<br>
		
		{!! Form::submit('Register clan', ['class' => 'btn btn-inverse']) !!}
		{!! Form::close() !!}		
	</div>
</div>

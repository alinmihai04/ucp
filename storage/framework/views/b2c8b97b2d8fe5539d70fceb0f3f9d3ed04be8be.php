...
<?php else: ?>
    ...
    <?php echo Form::open(['url' => route('2fa_disable')]); ?>

    <?php echo Form::label('password', 'Parola curenta:'); ?>

    <?php echo Form::password('password'); ?>

    <br>
    <?php echo Form::submit('Dezactiveaza', ['class' => 'btn btn-md btn-danger']); ?>

...
<div class="span8">
	...
	<?php if($me->user_admin >= 6): ?>
		<ul>
			...
			<li><a href="<?php echo e(url('/admin/resetraport')); ?>">RESETEAZA RAPOARTELE DE ACTIVITATE (DEBUG)</a></li>
		</ul>
	<?php endif; ?>
	...
	<?php $__currentLoopData = $groupdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		...
		<ul>
			<li>
				...
				<?php else: ?>
					<a href="<?php echo e(url('/group/app/' . $g->group_id)); ?>">open applications</a>
				<?php endif; ?>
			</li>	

			...
			<div class="widget-body">
				<div class="widget-main no-padding">
										...
										<p>
											...
											<span class="pull-right">
												<?php if(is_object($me) && ($me->id == $p->user_id || $me->user_admin >= 3)): ?>
														<a href="<?php echo e(url('/post/edit/' . $p->id)); ?>"><i class="icon-edit red"></i></a>
					...
					<?php if(is_object($me) && (($me->user_group == $data->faction && $me->user_grouprank >= 6) || $me->user_admin > 0)): ?>
						...
						<?php endif; ?>
						<br><br>
						<?php if($me->user_admin > 0 && $data->status == 0 && $data->faction == 0): ?>
							<?php echo Form::submit('Dovezi insuficiente', ['class' => 'btn btn-small btn-success', 'name' => 'dovezi', 'onclick' => 'return confirm("Esti sigur ca vrei sa trimiti un raspuns automat pentru dovezi insuficiente la aceasta reclamatie?");']); ?>

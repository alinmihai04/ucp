	...
	<div class="table-responsive">
		...
		<table id="sample-table-1" class="table table-striped table-bordered table-hover">
			...
			<tbody>
				...
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				<?php $__currentLoopData = $data->where('status', '=', 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $complaint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						<td>
							<?php if($complaint->reason == 7): ?>
								<a href="<?php echo e(url('/complaint/view/' . $complaint->id)); ?>"><?php echo e($complaint->name . ' - ' . App\Complaint::$reason_text[$complaint->reason] . ' - faction: ' . App\Group::getGroupName($complaint->user_group)); ?></a>
...
<?php echo $__env->make('layout.main', ['title' => 'Complaints'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
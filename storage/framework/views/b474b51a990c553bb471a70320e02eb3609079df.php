	  	 		...
	  	 		<div class="profile-user-info">
            		...
            		<?php if($auth && (Auth::id() == $data->id || $me->user_admin > 0)): ?>
             		...
             		<div class="profile-info-row">
                		...
                		<div class="profile-info-value">
                			<?php echo e($data->user_email); ?> <a href="<?php echo e(url('/user/changemail/'.$data->id)); ?>"><i class="icon-edit"></i></a>
                		</div>
            		</div>
            		<?php endif; ?>
            		<div class="profile-info-row">
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<?php else: ?>
									...
									<?php if($auth && $me->user_admin > 0): ?>
										<br>
										<a href="<?php echo e(url('/logs/house/' . $house->id)); ?>"><i class="icon-archive"></i> view logs (not implemented)</a>
									<?php endif; ?>
								<?php endif; ?>
							</div>
						</div>
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<?php else: ?>
									...
									<?php if($auth && $me->user_admin > 0): ?>
										<br>
										<a href="<?php echo e(url('/logs/biz/' . $biz->id)); ?>"><i class="icon-archive"></i> view logs (not implemented)</a>
									<?php endif; ?>
								<?php endif; ?>
							</div>
						</div>

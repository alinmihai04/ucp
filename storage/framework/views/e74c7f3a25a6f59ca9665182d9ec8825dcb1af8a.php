...
<div class="span8">
	...
	<div class="alert alert-info">
		...
		<p>
            <?php if($me->name == "Alin" || $me->name == "helper" || $me->name == "leader" || $me->name == "player"): ?>
		...
		<div class="infobox infobox-green">
			...
			<div class="infobox-data">
				...
				<div class="infobox-content">
					<a href="<?php echo e(url('/online')); ?>">jucatori online</a>
				</div>
			</div>
		</div>
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							...
							<ul>
								<li>Reclamatii normale: <b><a href="<?php echo e(url('/complaints/normal')); ?>"><?php echo e($complaints->where('reason', '!=', '2')->where('reason', '!=', '4')->where('reason', '!=', '6')->where('reason', '!=', '7')->where('status', '=', '0')->count()); ?> </a></b>  </li>
								<li>Reclamatii staff: <b><a href="<?php echo e(url('/complaints/staff')); ?>"><?php echo e($complaints->where('reason', '=', '6')->where('status', '=', '0')->count()); ?> </a></b></li>
								<li>Reclamatii lideri: <b><a href="<?php echo e(url('/complaints/leader')); ?>"><?php echo e($complaints->where('reason', '=', '7')->where('status', '=', '0')->count()); ?> </a></b></li>
								<li>Reclamatii inselatorii: <b><a href="<?php echo e(url('/complaints/scam')); ?>"><?php echo e($complaints->where('reason', '=', '4')->where('status', '=', '0')->count()); ?> </a></b></li>
								<li>Owner+: <b><a href="<?php echo e(url('/complaints/owner')); ?>"><?php echo e($complaints->where('status', '=', '2')->count()); ?> </a></b></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="itemdiv dialogdiv">
							...
							<div class="body">
								...
								<div class="text">
                                    ...
                                    ?>
									<p><?php echo preg_replace($tokens[0], "<a href=".url('/profile/'.$f->name.'').">".$f->name."</a>", $f->text, 1); ?></p>
								</div>
							</div>
						</div>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

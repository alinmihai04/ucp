...
Route::get('/decon/{user}', 'UserController@decon');
...
Route::post('/2fa','SecurityController@enable2fa')->name('enable2fa');
Route::post('/2fa/login','SecurityController@validateCode');
